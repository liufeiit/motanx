...
public class ConsulRegistry extends FailbackRegistry {
	private MotanxConsulClient client;
	...
	public ConsulRegistry(URL url, MotanxConsulClient client) {
		super(url);
		this.client = client;
	...
	private URL buildUrl(ConsulService service) {
		...
		params.put(URLParamType.nodeType.getName(),
				MotanxConstants.NODE_TYPE_SERVICE);
	...
	public void setConsulClient(MotanxConsulClient client) {
		this.client = client;
