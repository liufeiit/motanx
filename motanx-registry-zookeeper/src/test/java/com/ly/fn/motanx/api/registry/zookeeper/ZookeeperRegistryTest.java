...
import com.ly.fn.motanx.api.registry.zookeeper.ZookeeperRegistry;
...
public class ZookeeperRegistryTest {
    ...
    public void setUp() throws Exception {
        ...
        url = new URL(MotanxConstants.PROTOCOL_MOTANX, "127.0.0.1", 8001, "com.weibo.motan.demo.service.MotanDemoService");
        clientUrl = new URL(MotanxConstants.PROTOCOL_MOTANX, "127.0.0.1", 0, "com.weibo.motan.demo.service.MotanDemoService");
