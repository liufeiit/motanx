...
import com.ly.fn.motanx.service.RegistryService;
import com.ly.fn.motanx.service.ZkRegistryService;
...
public class ZkRegistryServiceTest {
    ...
    private String toGroupPath(String group) {
        return MotanxConstants.ZOOKEEPER_REGISTRY_NAMESPACE + MotanxConstants.PATH_SEPARATOR + group;
    }

    private String toServicePath(String group, String service) {
        return toGroupPath(group) + MotanxConstants.PATH_SEPARATOR + service;
    }

    private String toNodeTypePath(String group, String service, String nodeType) {
        return toServicePath(group, service) + MotanxConstants.PATH_SEPARATOR + nodeType;
    }

    private String toNodePath(String group, String service, String nodeType, String node) {
        return toNodeTypePath(group, service, nodeType) + MotanxConstants.PATH_SEPARATOR + node;
    }
}