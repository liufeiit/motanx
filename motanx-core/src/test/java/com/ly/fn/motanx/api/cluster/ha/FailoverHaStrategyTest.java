        ...
        mockery.checking(new Expectations() {
            {
                ...
                one(referers.get(0)).call(request);
                will(throwException(new MotanxServiceException("mock throw exception when call")));
        ...
        mockery.checking(new Expectations() {
            {
                ...
                will(throwException(new MotanxServiceException("mock throw exception when 1th call")));
                oneOf(referers.get(1)).call(request);
                will(throwException(new MotanxServiceException("mock throw exception when 2th call")));
            }
        });
