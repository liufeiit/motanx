...
import com.ly.fn.motanx.api.mock.MockClient;
...
public class MotanMultiConfigTest extends BaseTestCase {
    ...
    public void setUp() throws Exception {
        ...
        serviceConfig1 =
                createServiceConfig(IHello.class, new Hello(), group, version, mockProtocolConfig(MotanxConstants.PROTOCOL_MOTANX),
                        registryConfig, MotanxConstants.PROTOCOL_MOTANX + ":" + port1);
        serviceConfig2 =
                createServiceConfig(IHello.class, new Hello(), group, version, mockProtocolConfig(MotanxConstants.PROTOCOL_MOTANX),
                        registryConfig, MotanxConstants.PROTOCOL_MOTANX + ":" + port2);
        refererConfig1 = createRefererConfig(IHello.class);
        refererConfig1.setProtocol(mockProtocolConfig(MotanxConstants.PROTOCOL_MOTANX));
        ...
        refererConfig2.setProtocol(mockProtocolConfig(MotanxConstants.PROTOCOL_MOTANX));
    ...
    public void testMultiVersion() {
        ...
        try {
            ...
            serviceConfig1.setExport(MotanxConstants.PROTOCOL_MOTANX + ":" + port1);

            serviceConfig1.export();

            serviceConfig2.setVersion("2.0");
            serviceConfig2.setExport(MotanxConstants.PROTOCOL_MOTANX + ":" + port2);
