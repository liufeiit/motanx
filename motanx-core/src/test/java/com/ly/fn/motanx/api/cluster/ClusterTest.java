...
import com.ly.fn.motanx.api.cluster.ha.FailoverHaStrategy;
import com.ly.fn.motanx.api.cluster.loadbalance.RandomLoadBalance;
import com.ly.fn.motanx.api.cluster.support.ClusterSpi;
...
public class ClusterTest extends BaseTestCase {
    ...
    public void setUp() throws Exception {
        ...
        cluster.setUrl(new URL(MotanxConstants.PROTOCOL_MOTANX, NetUtils.getLocalAddress().getHostAddress(), 0, RegistryService.class
                .getName()));
        ...
        mockery.checking(new Expectations() {
            {
                ...
                will(returnValue(new URL(MotanxConstants.PROTOCOL_MOTANX, NetUtils.getLocalAddress().getHostAddress(), 18080, Object.class
                        .getName())));
