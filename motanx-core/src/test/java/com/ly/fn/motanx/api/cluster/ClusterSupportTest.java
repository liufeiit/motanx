...
public class ClusterSupportTest {
    ...
    public void testNotify() {
        ...
        for (int i = 0; i < urlsCount; i++) {
            URL url = new URL(MotanxConstants.PROTOCOL_MOTANX, localAddress, 1000 + i, IHello.class.getName());
            url.addParameter(URLParamType.nodeType.getName(), MotanxConstants.NODE_TYPE_SERVICE);
    ...
    private static List<URL> mockRegistryUrls() {
        URL refUrl = new URL(MotanxConstants.PROTOCOL_MOTANX, NetUtils.getLocalAddress().getHostAddress(), 0, IHello.class.getName());
