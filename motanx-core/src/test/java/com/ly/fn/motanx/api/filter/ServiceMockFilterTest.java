...
import com.ly.fn.motanx.api.filter.ServiceMockFilter;
import com.ly.fn.motanx.api.protocol.example.IHello;
import com.ly.fn.motanx.api.protocol.example.IHelloMock;
...
public class ServiceMockFilterTest extends BaseTestCase {
    ...
    public void testCall() {
        ...
        final URL url = new URL(MotanxConstants.PROTOCOL_MOTANX, NetUtils.getLocalAddress().getHostAddress(), 0, IHello.class.getName());
