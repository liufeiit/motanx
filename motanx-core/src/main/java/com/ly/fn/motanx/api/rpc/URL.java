...
public class URL {
    ...
    public static URL valueOf(String url) {
        if (StringUtils.isBlank(url)) {
            throw new MotanxServiceException("url is null");
        }
    ...
    public String getMethodParameter(String methodName, String paramDesc, String name) {
        String value = getParameter(MotanxConstants.METHOD_CONFIG_PREFIX + methodName + "(" + paramDesc + ")." + name);
    ...
    public String getUri() {
        return protocol + MotanxConstants.PROTOCOL_SEPARATOR + host + ":" + port +
                MotanxConstants.PATH_SEPARATOR + path;
    }
    ...
    public boolean canServe(URL refUrl) {
        ...
        if (!StringUtils.equals(this.getParameter(URLParamType.nodeType.getName()), MotanxConstants.NODE_TYPE_SERVICE)) {
            return false;
        }
