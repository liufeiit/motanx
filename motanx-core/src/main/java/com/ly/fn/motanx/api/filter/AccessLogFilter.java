...
public class AccessLogFilter implements Filter {
    ...
    private void logAccess(Caller<?> caller, Request request, long consumeTime, boolean success) {
        if (getSide() == null) {
            String side = caller instanceof Provider ? MotanxConstants.NODE_TYPE_SERVICE : MotanxConstants.NODE_TYPE_REFERER;
            setSide(side);
        }
        ...
        if (MotanxConstants.NODE_TYPE_REFERER.equals(side)) {
    ...
    private void append(StringBuilder builder, Object field) {
        ...
        builder.append(MotanxConstants.SEPERATOR_ACCESS_LOG);
    }
